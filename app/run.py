...
# load data
engine = create_engine("sqlite:///../data/nnguyen_disaster_response_data.db")
df = pd.read_sql_table('nnguyen_disaster_response_data', engine)

# load model
model = joblib.load("../models/nnguyen_classifier.pkl")
